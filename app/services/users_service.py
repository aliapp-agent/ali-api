...
from app.models.user_activity import UserActivity, UserInvitation, UserSession
...
class UsersService:
    ...
    async def create_user(
        ...
        try:
            ...
            user = User(
                ...
                } if user_data.permissions else None,
        ...
        try:
            ...
            for i in range(search_request.page_size):
                ...
                user = User(
                    ...
                    role="viewer" if i % 3 == 0 else "editor" if i % 3 == 1 else "admin",
                    status="active",
                    is_verified=i % 2 == 0,
                    is_active=True,
                    login_count=i * 5,
                    ...
                    last_login=datetime.utcnow() - timedelta(hours=i * 2) if i % 2 == 0 else None,
                    profile={
                        "first_name": f"User",
                        "last_name": f"{user_id}",
                        "organization": "Example Corp" if i % 2 == 0 else "Another Corp"
                    }
                )
            ...
            for user_id in user_ids:
                try:
                    ...
                    if operation == "activate":
                        ...
                        await self.delete_user(user_id, operator_user_id, soft_delete=True)
                        success_count += 1
    ...
    async def check_user_permission(
        ...
        try:
            ...
            return UserPermissionResponse(
                ...
                effective_permissions=[Permission(p) for p in user.get_all_permissions()],
    ...
    def _user_to_response(self, user: User) -> UserResponse:
        ...
        """
        from app.schemas.users import UserRole, UserStatus, UserPreferences, UserProfile
        ...
        return UserResponse(
            ...
            permissions=[Permission(p) for p in user.permissions.get("additional", [])] if user.permissions else [],
