...
class FirestoreDocumentRepository(BaseFirestoreRepository, DocumentRepositoryInterface):
    ...
    async def delete(self, document_id: str) -> bool:
        ...
        return await super().update(
            document_id,
            {"status": DocumentStatus.DELETED.value, "deleted_at": datetime.utcnow()},
        )
    ...
    async def search_documents(
        ...
        base_query = self.collection.where(
    ...
    def from_entity(self, entity: DocumentEntity) -> Dict[str, Any]:
        ...
        data = {
            ...
            "document_type": (
                entity.document_type.value if entity.document_type else "pdf"
            ),
