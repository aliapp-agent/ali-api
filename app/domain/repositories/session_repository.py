...
class SessionRepositoryInterface(ABC):
    ...
    async def get_active_sessions(
        self, limit: int = 100, older_than: Optional[datetime] = None
    ) -> List[SessionEntity]:
        """Get active sessions.
    ...
    async def update_session_activity(
        self, session_id: str, last_activity: Optional[datetime] = None
    ) -> bool:
    ...
    async def record_session_message(
        self, session_id: str, tokens_used: int = 0, response_time: float = 0.0
    ) -> bool:
