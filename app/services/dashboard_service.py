...
class DashboardService:
    ...
    async def get_dashboard_data(
        ...
        try:
            # Check cache first
            cache_key = f"dashboard_{request.time_range.value}_{hash(str(request.dict()))}"
        ...
        try:
            ...
            return UserAnalytics(
                ...
                top_user_activities=[
                    ...
                    {"activity": "chat_interaction", "count": 12459, "percentage": 35.9},
        ...
        try:
            ...
            return ChartData(
                ...
                series=[
                    {
                        "name": metric,
                        "data": [dp.value + random.uniform(-50, 50) for dp in data_points]
                    }
