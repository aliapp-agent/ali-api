        ...
        if client.ping():
            ...
            if client.indices.exists(index=index_name):
                ...
                try:
                    ...
                    print(f"⚠️  Não foi possível obter contagem de documentos: {e}")
                ...
                try:
                    ...
                    print(f"✅ Busca de teste bem-sucedida!")
                    print(f"Total de hits: {search_response['hits']['total']['value']}")
                except Exception as e:
                    print(f"⚠️  Erro na busca de teste: {e}")
                    
            else:
                print(f"⚠️  Índice '{index_name}' não encontrado. Será criado automaticamente.")
